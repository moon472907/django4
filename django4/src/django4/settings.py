...
#서버에러나 page not found 에러등이 아보이도록  개발자 모드 설정변수 
#debug = true  = 개발자모드
#false = 배포모드
DEBUG = True
...
#ID와 보안 비밀을 저장하는 변수
SOCIAL_AUTH_GOOGLE_PLUS_KEY = '296901031309-gkfi44f0sfq5nrfo4iheo9vv36fntqve.apps.googleusercontent.com'
SOCIAL_AUTH_GOOGLE_PLUS_SECRET = 't0ek2SHxy2pMgFbbcIrBpSks'
